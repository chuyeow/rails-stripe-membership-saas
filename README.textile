...
You have several options for getting the code. You can _develop in the cloud_, _fork_, _clone_, or _generate_.

h3. Develop in the Cloud

Click this button to run this example application in the cloud with "Nitrous.IO":https://www.nitrous.io:

!https://d3o0mnbgv6k92a.cloudfront.net/assets/hack-l-v1-3cc067e71372f6045e1949af9d96095b.png(Hack chuyeow/rails-stripe-membership-saas on Nitrous.IO)!:https://www.nitrous.io/hack_button?source=embed&runtime=rails&repo=chuyeow%2Frails-stripe-membership-saas&file_to_open=README.nitrous.md

This creates a Rails-ready development environment so you can run this straight from your web browser.
